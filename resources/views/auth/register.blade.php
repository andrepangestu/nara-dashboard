...
<body class="hold-transition login-page login-layout">
  <div class="login-box">
    <div class="text-center"
      style="position: absolute; top: 30%; left: 50%; transform: translate(-50%, -50%); z-index: 9999; ">
    ...
    <div class="card card-outline login-card">
      <div class="card-body">
        <form action="{{ route('register.post') }}" method="post">
          ...
          <div class="row">
            <div class="col-12">
              <button type="submit" class="btn btn-block btn-light custom-button-login">Register</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
